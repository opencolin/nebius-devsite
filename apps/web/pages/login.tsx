...
// https://auth.tenki.cloud/ui/login. We deliberately skip
...
export default function LoginPage({next}: Props) {
  return (
    <>
      <Head>
        <title>{`Sign in · Tenki Builders`}</title>
        <meta
          name="description"
          content="Sign in to the Tenki Builders portal — credits, ambassador status, office hours, and the leaderboard."
        />
      </Head>
