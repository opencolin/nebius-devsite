...
export default function EventsMap({events, onCityClick, activeCity, variant = 'light'}: EventsMapProps) {
  ...
  useEffect(() => {
    ...
    async function loadAndInit() {
      ...
      mapInstanceRef.current = map as LeafletMap;
    ...
    // Rebuild on events / activeCity / variant change — events for new data,
    // activeCity to flip dot styles, variant to swap tile layers. Cheap
    // because marker count is small.
  }, [events, activeCity, variant]);
